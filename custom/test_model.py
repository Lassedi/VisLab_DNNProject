...
class FreeConvNetwork(nn.Module):
    def __init__(self):
        ...
        self.LL1 = LocallyConnected2d(3, out_channels=32, output_size=(108,88), kernel_size=3, stride=2, bias=True)
        ...
        self.LL2 = LocallyConnected2d(32, 64, (53,43), 3, 2,True) # here input size = output size previous layer not out_channels
        self.LL3 = LocallyConnected2d(64, 64, (26,21), 3, 2,True) # here input size = output size previous layer not out_channels
        ...
        self.linear1 = nn.Linear(64*26*21, 1000) # input size = output_channels*output_size/2 of last Local layer because of maxpool2d kernel size 2
